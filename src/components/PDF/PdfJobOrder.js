...
const PdfJobOrder = ({id,quoteId}) => {
  PdfJobOrder.propTypes = {
    id: PropTypes.any,
  ...
  const getCompany = () => {
    api
      .post('/joborder/getJobOrderById', { project_job_id: id })
      .then((res) => {
  ...
  const getQuoteById = () => {
    api
      .post('/joborder/getJobLineItemsById', { project_job_id: quoteId })
      .then((res) => {
  ...
  const GetPdf = () => {
    ...
    const dd = {
      ...
      content: [
        ...
        {
          text: `Date :   ${(quote.job_date)? moment(quote.job_date).format('DD-MM-YYYY'):''}
           Job Code :  ${quote.job_code ? quote.job_code : ''
          }\n \n  `,
        ...
        },
        {
          text: `Dear Sir,
           ...
           With reference to the above captions, we would like to thank you for inviting us to quote for the above mentioned works and we are pleased to submit herewith our Value JoPdfJobOrder for you kind persual.`,
