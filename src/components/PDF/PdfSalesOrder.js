...
const PdfQuote = ({ id,orderId }) => {
  ...
  const getQuoteById = () => {
    api
      .post('/finance/getOrdersByIds', { order_id: orderId })
      .then((res) => {
