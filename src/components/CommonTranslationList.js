...
const CommonTranslationList = ({tablevalue,tableNameUni,whereCondition}) => {
  CommonTranslationList.propTypes = {
    tablevalue: PropTypes.any,
    tableNameUni: PropTypes.any,
    whereCondition: PropTypes.any,
  };
console.log('tablevalue',tablevalue)
console.log('tableNameUni',tableNameUni)
...
const fetchTranslation = async () => {
  try {
    tablevalue.forEach(async (table) => {
      ...
      const res2 = await api.post('/commonApi/getTranslationGetApi',{tableNameUni,whereCondition});
...
export default CommonTranslationList;
