    ...
    <Card>
      <CardBody className="text-center p-4 border-bottom">
        ...
        <div className="d-flex align-items-center justify-content-center mt-4 gap-2">
          <a href="/" className="badge bg-primary text-white rounded-pill text-decoration-none">
            Dashboard
          </a>
          <a href="/" className="badge bg-light text-dark rounded-pill text-decoration-none">
            UI
          </a>
          <a href="/" className="badge bg-light text-dark rounded-pill text-decoration-none">
            UX
